---
article_id: SBT-06-03
title: "Banding, Patch, dan Overspray"
slug: "cacat-visual-sandblast"
...
date_modified: null
parent_topic: SBT-06
primary_intent: "Recognize workmanship defects"
reader_community: "Kacatempered.co.id"
reader_address: "Teman Kacatempered.co.id"
final_route: "/artikel/cacat-visual-sandblast.html"
...
# Banding, Patch, dan Overspray

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Banding, Patch, dan Overspray”
...
- **Primary intent:** Recognize workmanship defects
...
- **Scope boundary:** Acceptance evidence
- **Final public route:** `/artikel/cacat-visual-sandblast.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Banding, Patch, dan Overspray**.
...
- `SBT-06-02` → `/artikel/uniformity-kaca-sandblast.html` — Uniformity pada Bidang Sandblast Besar
- `SBT-06-04` → `/artikel/konsistensi-batch-sandblast.html` — Konsistensi Antarbatch Panel
- `SBT-06-05` → `/artikel/kualitas-edge-masking.html` — Edge Masking dan Kerapian Batas
...
- **Tie back to this article:** Keep the explanation specific to “Banding, Patch, dan Overspray”.
