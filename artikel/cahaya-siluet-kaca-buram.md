---
article_id: SBT-03-03
title: "Cahaya Tembus dan Siluet di Balik Kaca"
slug: "cahaya-siluet-kaca-buram"
description: "Set opacity, translucency, contrast, and day/night expectations"
status: outline
publication_date: "2026-01-31"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: SBT-03
primary_intent: "Set visibility expectations"
reader_community: "Kacatempered.co.id"
reader_address: "Kawan Kacatempered.co.id"
final_route: "/artikel/cahaya-siluet-kaca-buram.html"
...
# Cahaya Tembus dan Siluet di Balik Kaca

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Cahaya Tembus dan Siluet di Balik Kaca”
- **Reader and situation:** Set opacity, translucency, contrast, and day/night expectations
- **Reader outcome:** Set opacity, translucency, contrast, and day/night expectations
- **Primary intent:** Set visibility expectations
...
- **Scope boundary:** Optical planning
- **Final public route:** `/artikel/cahaya-siluet-kaca-buram.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Cahaya Tembus dan Siluet di Balik Kaca**.
...
- `SBT-03-01` → `/artikel/menentukan-privasi-sandblast.html` — Menentukan Tingkat Privasi Kaca Sandblast
- `SBT-03-02` → `/artikel/privasi-sandblast-siang-malam.html` — Privasi Siang vs Malam
- `SBT-03-04` → `/artikel/gradient-sandblast-privacy.html` — Gradient Sandblast untuk Privacy Zoning
- `SBT-03-05` → `/artikel/clear-border-kaca-sandblast.html` — Border Clear pada Panel Sandblast
...
- **Tie back to this article:** Keep the explanation specific to “Cahaya Tembus dan Siluet di Balik Kaca”.
