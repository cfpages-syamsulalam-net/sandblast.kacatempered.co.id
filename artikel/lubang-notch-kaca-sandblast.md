---
article_id: SBT-07-03
title: "Lubang dan Notch pada Kaca Sandblast"
slug: "lubang-notch-kaca-sandblast"
...
date_modified: null
parent_topic: SBT-07
primary_intent: "Control penetrations"
reader_community: "Kacatempered.co.id"
reader_address: "Teman Kacatempered.co.id"
final_route: "/artikel/lubang-notch-kaca-sandblast.html"
...
# Lubang dan Notch pada Kaca Sandblast

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Lubang dan Notch pada Kaca Sandblast”
...
- **Primary intent:** Control penetrations
...
- **Scope boundary:** Processor limits
- **Final public route:** `/artikel/lubang-notch-kaca-sandblast.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Lubang dan Notch pada Kaca Sandblast**.
...
- `SBT-07-01` → `/artikel/checklist-ukuran-panel-sandblast.html` — Checklist Ukuran Panel Sandblast
- `SBT-07-02` → `/artikel/polished-vs-ground-edge-sandblast.html` — Polished Edge vs Ground Edge
- `SBT-07-04` → `/artikel/orientasi-sisi-sandblast.html` — Orientasi Sisi Sandblast pada Rakitan
...
- **Tie back to this article:** Keep the explanation specific to “Lubang dan Notch pada Kaca Sandblast”.
