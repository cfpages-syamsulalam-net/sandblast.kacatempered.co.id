---
article_id: SBT-07-04
title: "Orientasi Sisi Sandblast pada Rakitan"
slug: "orientasi-sisi-sandblast"
description: "Control glass geometry and sequence before heat treatment"
status: outline
publication_date: "2026-05-03"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: SBT-07
primary_intent: "Choose exposed/protected face"
reader_community: "Kacatempered.co.id"
reader_address: "Sobat Kacatempered.co.id"
final_route: "/artikel/orientasi-sisi-sandblast.html"
...
# Orientasi Sisi Sandblast pada Rakitan

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Orientasi Sisi Sandblast pada Rakitan”
- **Reader and situation:** Control glass geometry and sequence before heat treatment
- **Reader outcome:** Control glass geometry and sequence before heat treatment
- **Primary intent:** Choose exposed/protected face
...
- **Scope boundary:** Cleanability/assembly
- **Final public route:** `/artikel/orientasi-sisi-sandblast.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Orientasi Sisi Sandblast pada Rakitan**.
...
- `SBT-07-02` → `/artikel/polished-vs-ground-edge-sandblast.html` — Polished Edge vs Ground Edge
- `SBT-07-03` → `/artikel/lubang-notch-kaca-sandblast.html` — Lubang dan Notch pada Kaca Sandblast
- `SBT-07-05` → `/artikel/label-arah-pattern-panel.html` — Label Panel dan Pattern Direction
- `SBT-07-06` → `/artikel/hold-point-fabrikasi-sandblast.html` — Hold Point Sebelum Kaca Diproses
...
- **Tie back to this article:** Keep the explanation specific to “Orientasi Sisi Sandblast pada Rakitan”.
